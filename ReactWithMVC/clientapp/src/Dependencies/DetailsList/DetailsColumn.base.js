...
import { Icon, FontIcon } from "../@uifabric/icons";
import {
  ...
  DetailsColumnBase.prototype.render = function () {
    ...
    var _d = this.props.onRenderColumnHeaderTooltip,
      onRenderColumnHeaderTooltip =
        _d === void 0 ? this._onRenderColumnHeaderTooltip : _d;
    this._classNames = getClassNames(styles, {
      ...
      isNotAction: column.isNotAction,
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        {
          ...
          "data-rc-id": rcName ? `col.${column.key}.${rcName}` : undefined,
        },
        isDraggable &&
              ...
              "span",
              {
                ...
                role:
                  ...
                  (column.onColumnClick !== undefined ||
                    this.props.onColumnClick !== undefined)
                    ? "button"
                    : undefined,
                "aria-describedby":
              ...
              React.createElement(
                ...
                (column.iconName || column.iconClassName) &&
                  React.createElement(IconComponent, {
                    ...
                    "data-rc-id": `ico.${column.iconName}`,
                  }),
                column.isIconOnly
                  ? React.createElement(
                      "span",
      ...
      column.isFilter &&
        (!column.isIconOnly || column.isIconOnly === undefined) &&
        React.createElement(
          "div",
          {
    ...
    if (this.props.isDropped) {
      ...
      this._async.setTimeout(function () {
        if (_this._root.current) {
          ...
          _this._root.current.classList.remove(
            classNames.noBorderAfterDropping
          );
        }
