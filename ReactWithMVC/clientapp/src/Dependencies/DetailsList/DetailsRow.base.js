...
var DetailsRowBase = /** @class */ (function (_super) {
  ...
  DetailsRowBase.prototype.shouldComponentUpdate = function (
    nextProps,
    nextState
  ) {
  ...
  DetailsRowBase.prototype.render = function () {
    ...
    var isDraggable = dragDropEvents
      ? !!(dragDropEvents.canDrag && dragDropEvents.canDrag(item))
      : undefined;
    var droppingClassName = isDropping
      ? this._droppingClassNames || DEFAULT_DROPPING_CSS_CLASS
      : "";
    var ariaLabel = getRowAriaLabel ? getRowAriaLabel(item) : undefined;
    var ariaDescribedBy = getRowAriaDescribedBy
      ? getRowAriaDescribedBy(item)
      : undefined;
    ...
    var ariaSelected =
      selectionMode === SelectionMode.none ? undefined : isSelected;
    this._classNames = __assign(
      __assign({}, this._classNames),
    ...
    return React.createElement(
      ...
      showCheckbox &&
        React.createElement(
          ...
          onRenderCheck({
            ...
            rcName: `${rcName}.${itemIndex}`,
            "data-rc-id": rcName ? `row.cbx.${rcName}.${itemIndex}` : undefined,
            canSelect: canSelect,
            compact: compact,
      ...
      React.createElement(GroupSpacer, {
        ...
        count:
          groupNestingDepth -
          (this.props.collapseAllVisibility === CollapseAllVisibility.hidden
            ? 1
            : 0),
      }),
      item && rowFields,
  ...
  DetailsRowBase.prototype._onRenderCheck = function (props) {
    return React.createElement(
      DetailsRowCheck,
      __assign({ rcName: props.rcName }, props)
    );
  };
  DetailsRowBase.prototype._getSelectionState = function (props) {
    ...
    return {
      ...
      isSelectionModal:
        !!selection && !!selection.isModal && selection.isModal(),
    };
  };
