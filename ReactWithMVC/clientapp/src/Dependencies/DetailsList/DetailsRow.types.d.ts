...
import { IDragDropHelper, IDragDropEvents } from "../@uifabric/utilities";
import { IViewport } from "../@uifabric/utilities/decorators";
 ...
 * {@docCategory DetailsList}
 */
export declare type IDetailsRowStyleProps = Required<
  Pick<IDetailsRowProps, "theme">
> & {
