...
import { IStyle, Omit } from "../@uifabric/styling";
import { IStyleFunctionOrObject } from "../@uifabric/utilities";
/**
 * ShimmeredDetailsList props interface
 * {@docCategory DetailsList}
 */
export interface IShimmeredDetailsListProps
  extends Omit<IDetailsListProps, "styles"> {
  /**
   ...
   */
  shimmerOverlayStyles?: IStyleFunctionOrObject<
 ...
 * {@docCategory DetailsList}
 */
export declare type IShimmeredDetailsListStyleProps = Required<
  Pick<IShimmeredDetailsListProps, "theme">
>;
/**
