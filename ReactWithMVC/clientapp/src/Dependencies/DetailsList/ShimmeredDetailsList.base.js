...
import { classNamesFunction, css } from "../@uifabric/utilities";
    ...
    _this._renderDefaultShimmerPlaceholder = function (rowProps) {
      ...
      if (showCheckbox) {
        shimmerElementsRow.push(
          React.createElement(ShimmerElementsGroup, {
            key: "checkboxGap",
            shimmerElements: [
              {
    ...
    var newListProps = __assign(__assign({}, listProps), {
      ...
      className:
        enableShimmer && !removeFadingOverlay
          ? css(this._classNames.root, listClassName)
          : listClassName,
    });
    return React.createElement(
      DetailsList,
      __assign({}, restProps, {
        ...
        isShimmerLoading: enableShimmer ? true : false,
        rcName,
      })
    );
  };
