  ...
  DetailsHeaderBase.prototype.render = function () {
    ...
    return React.createElement(
      ...
      showCheckbox
        ? [
            React.createElement(
              "div",
              {
                ...
                "aria-colindex": 1,
                role: "columnheader",
                "data-rc-id": rcName ? `col.checkAll.${rcName}` : undefined,
              },
              onRenderColumnHeaderTooltip(
                {
        ...
        : null,
      groupNestingDepth > 0 &&
        this.props.collapseAllVisibility === CollapseAllVisibility.visible
        ? React.createElement(
            "div",
            {
  ...
  DetailsHeaderBase.prototype._getColumnReorderProps = function () {
    ...
    return (
      ...
      (columnReorderOptions &&
        __assign(__assign({}, columnReorderOptions), {
