...
import { css, styled, classNamesFunction, Check } from "../@uifabric/utilities";
...
var DetailsRowCheckBase = function (props) {
  var _a = props.isVisible,
    ...
    useFastIcons = _f === void 0 ? true : _f, // must be removed from buttonProps
    buttonProps = __rest(props, [
      "isVisible",
      "canSelect",
      "anySelected",
      "selected",
  ...
  return canSelect
    ? React.createElement(
        ...
        __assign({}, buttonProps, {
          ...
          // "data-rc-id": rcName ? `dl.cbx.${rcName}` : undefined,
        }),
...
export var DetailsRowCheck = styled(
  DetailsRowCheckBase,
  getStyles,
  undefined,
