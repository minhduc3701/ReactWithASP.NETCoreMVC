...
export interface IDetailsListProps
  ...
  onGetSelectedGroups?: (groups: IGroup | IGroup[]) => void;
 ...
 * {@docCategory DetailsList}
 */
export declare type IDetailsListStyleProps = Required<
  Pick<IDetailsListProps, "theme">
> &
 ...
 * {@docCategory DetailsList}
 */
export interface IDetailsGroupDividerProps
