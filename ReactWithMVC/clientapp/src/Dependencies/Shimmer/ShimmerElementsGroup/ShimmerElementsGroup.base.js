...
import { classNamesFunction, memoizeFunction } from "../../@uifabric/utilities";
import {
  ShimmerElementType,
...
export var ShimmerElementsGroupBase = function (props) {
  var styles = props.styles,
    ...
    _b = props.rowHeight,
    rowHeight =
      _b === void 0 ? findMaxElementHeight(shimmerElements || []) : _b,
    _c = props.flexWrap,
  ...
  return React.createElement(
    "div",
    { style: { width: width }, className: classNames.root },
...
function getRenderedElements(shimmerElements, backgroundColor, rowHeight) {
  var renderedElements = shimmerElements
    ? shimmerElements.map(function (element, index) {
        ...
        switch (element.type) {
          case ShimmerElementType.circle:
            return React.createElement(
              ShimmerCircle,
              __assign({ key: index }, filteredElem, { styles: styles })
            );
...
var getElementStyles = memoizeFunction(function (
  verticalAlign,
  elementType,
  elementHeight,
  backgroundColor,
