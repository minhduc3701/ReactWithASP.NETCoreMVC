...
var Autofill = /** @class */ (function (_super) {
  ...
  function Autofill(props) {
    ...
    _this._onInputChanged = function (ev) {
      ...
      if (!(isIE11() && _this._isComposing)) {
        ...
        var isComposing =
          nativeEventComposing === undefined
            ? _this._isComposing
    ...
    _this._updateValue = function (newValue, composing) {
      ...
      _this._value = _this.props.onInputChange
        ? _this.props.onInputChange(newValue, composing)
        : newValue;
      _this.setState(
        {
          displayValue: _this._getDisplayValue(
            _this._value,
  ...
  Autofill.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
    ...
    var newDisplayValue = this._getDisplayValue(
      this._value,
      ...
      type === "users" &&
        React.createElement(
          Icon,
          {
            ...
            styles: {
              root: {
                color: darkMode === "dark" ? "#69afe5" : "#0078d4",
                padding: "0 8px",
                cursor: "default",
              },
            },
        ...
        __assign(
          {
            ...
            "data-rc-id": rcName ? `txt.${rcName}` : undefined,
          },
          nativeProps,
          {
            ref: this._inputElement,
            value: this.props.defaultVisibleValue,
