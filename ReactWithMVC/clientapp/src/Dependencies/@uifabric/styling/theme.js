...
import {
  merge
} from "../utilities/merge";
import {
  Customizations
} from "../utilities/customizations/Customizations";
...
export function createTheme(theme, depComments) {
  ...
  if (theme.defaultFontStyle) {
    for (
      var _i = 0, _a = Object.keys(defaultFontStyles); _i < _a.length; _i++
    ) {
      var fontStyle = _a[_i];
