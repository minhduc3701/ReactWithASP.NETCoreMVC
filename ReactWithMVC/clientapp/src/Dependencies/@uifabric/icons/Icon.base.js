...
var IconBase = /** @class */ (function (_super) {
  ...
  IconBase.prototype.render = function () {
    ...
    var containerProps = ariaLabel
      ...
      : {
          "aria-hidden":
            this.props["aria-labelledby"] || imageProps["aria-labelledby"]
              ? false
              : true,
        };
    return React.createElement(
      ...
      __assign(
        {
          ...
          "data-rc-id": rcName ? `ico.${rcName}` : undefined,
        },
        containerProps,
        nativeProps,
        {
      ...
      isImage
        ? React.createElement(ImageType, __assign({}, imageProps))
        : children || iconContentChildren
    );
  };
  return IconBase;
})(React.Component);
