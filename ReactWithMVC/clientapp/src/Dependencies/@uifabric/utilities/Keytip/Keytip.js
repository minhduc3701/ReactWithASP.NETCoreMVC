...
import { mergeOverflows, ktpTargetFromSequences } from "../index";
...
var Keytip = /** @class */ (function (_super) {
  ...
  Keytip.prototype.render = function () {
    ...
    if (overflowSetSequence) {
      keytipTarget = ktpTargetFromSequences(
        mergeOverflows(keySequences, overflowSetSequence)
      );
    } else {
