...
import { mergeCss } from "../../styling";
import { getRTL, memoizeFunction, assign } from "../index";
/**
...
export function withSlots(type, props) {
  ...
  if (slotType.isSlot) {
    ...
    return React.createElement.apply(
      React,
      __spreadArrays([type, props], children)
    );
  }
}
/**
...
export function createFactory(DefaultComponent, options) {
  ...
  var result = function (
    ...
    var finalProps = _constructFinalProps(
      defaultStyles,
      theme,
      componentProps,
      flattenedUserProps
    ...
    if (slots.hasOwnProperty(name_1)) {
      ...
      var slot = function (componentProps) {
        ...
        return _renderSlot(
          ...
          componentProps,
          mixedProps[name_1],
          mixedProps.slots && mixedProps.slots[name_1],
...
function _translateShorthand(defaultProp, slotProps) {
  ...
  if (
    typeof slotProps === "string" ||
    typeof slotProps === "number" ||
    typeof slotProps === "boolean"
  ) {
...
function _renderSlot(
  ...
  if (ComponentType.create !== undefined) {
    ...
    return defaultFactory(ComponentType)(
      componentProps,
      userProps,
      slotOptions,
      defaultStyles,
