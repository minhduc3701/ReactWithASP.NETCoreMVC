 ...
 */
export declare type ISlottableComponentType<
  TProps extends ValidProps,
  TShorthandProp extends ValidShorthand
 ...
 */
export declare type ISlottableReactType<
  TProps extends ValidProps,
  TShorthandProp extends ValidShorthand
...
export interface ISlot<TProps> {
  (
    componentProps: React.PropsWithChildren<TProps> | undefined | null
 ...
 */
export declare type ISlotFactory<
  TProps extends ValidProps,
  TShorthandProp extends ValidShorthand
> = (
 ...
 */
export declare type ExtractProps<TUnion> = TUnion extends ISlotProp<
  infer TProps
>
  ? TProps
  : never;
 ...
 */
export declare type ExtractShorthand<TUnion> = TUnion extends boolean
  ? boolean
 ...
 */
export declare type ISlotProp<
  TProps extends ValidProps,
  TShorthandProp extends ValidShorthand = never
 ...
 */
export declare type ISlotRender<TProps> = (
