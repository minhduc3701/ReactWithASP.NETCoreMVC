 ...
 */
export declare type IPropsWithChildren<TProps> = React.PropsWithChildren<
  TProps
>;
/**
 ...
 */
export declare type IStylesFunction<
  TViewProps,
  TTokens,
 ...
 */
export declare type IStylesFunctionOrObject<
  TViewProps,
  TTokens,
  TStyleSet extends IStyleSet<TStyleSet>
 ...
 */
export declare type IToken<TViewProps, TTokens> =
  | ITokenBase<TViewProps, TTokens>
  | ITokenBaseArray<TViewProps, TTokens>;
/**
 * Function declaration for component token functions.
 */
export declare type ITokenFunction<TViewProps, TTokens> = (
  props: TViewProps,
  theme: ITheme
) => IToken<TViewProps, TTokens>;
/**
 * Composite type for component token functions and objects.
 */
export declare type ITokenFunctionOrObject<TViewProps, TTokens> =
 ...
 */
export declare type ITokenBase<TViewProps, TTokens> =
 ...
 */
export interface ITokenBaseArray<TViewProps, TTokens>
...
export declare type ICustomizationProps<
  TViewProps,
  TTokens,
  TStyleSet extends IStyleSet<TStyleSet>
> = IStyleableComponentProps<TViewProps, TTokens, TStyleSet> &
  Required<
    Pick<IStyleableComponentProps<TViewProps, TTokens, TStyleSet>, "theme">
  >;
/**
 * Defines the contract for state components.
 */
export declare type IStateComponentType<TComponentProps, TViewProps> = (
  props: Readonly<TComponentProps>
) => TViewProps;
/**
 * Defines the contract for view components.
 */
export declare type IViewComponent<TViewProps> = (
