...
import { hasSubmenu, getIsChecked, isItemDisabled } from "../index";
import {
  withResponsiveMode,
  ResponsiveMode,
} from "../decorators/withResponsiveMode";
...
import { concatStyleSetsWithProps } from "../../styling/index";
...
var _getMenuItemStylesFunction = memoizeFunction(function () {
  ...
  return function (styleProps) {
    return concatStyleSetsWithProps.apply(
      void 0,
      __spreadArrays([styleProps, getItemStyles], styles)
    );
  };
});
var ContextualMenuBase = /** @class */ (function (_super) {
  ...
  function ContextualMenuBase(props) {
    ...
    _this._onRenderMenuList = function (menuListProps, defaultRender) {
      ...
      return React.createElement(
        ...
        menuListProps.items.map(function (item, index) {
          var itemCustom = item;
          var menuItem = _this._renderMenuItem(
            itemCustom,
            index,
            indexCorrection,
     ...
     */
    _this._renderMenuItem = function (
      item,
      index,
      ...
      if (getItemClassNames) {
        itemClassNames = getItemClassNames(
          _this.props.theme,
          isItemDisabled(item),
          _this.state.expandedMenuItemKey === item.key,
          !!getIsChecked(item),
          !!item.href,
        ...
        itemClassNames = getContextualMenuItemClassNames(
          _getMenuItemStylesFunction(
            (_a = _this._classNames.subComponentStyles) === null ||
              _a === void 0
              ? void 0
              : _a.menuItem,
            styles
      ...
      switch (item.itemType) {
        ...
        case ContextualMenuItemType.Header:
          renderedItems.push(_this._renderSeparator(index, itemClassNames));
          var headerItem = _this._renderHeaderMenuItem(
            item,
            itemClassNames,
            index,
            hasCheckmarks,
        ...
        case ContextualMenuItemType.Section:
          ...
          break;
        default:
          var menuItem = _this._renderNormalItem(
            item,
            itemClassNames,
            index,
            focusableElementIndex,
    ...
    _this._onKeyDown = function (ev) {
      ...
      var dismissAllMenus =
        ev.which === KeyCodes.escape && (isMac() || isIOS());
    ...
    _this._onKeyUp = function (ev) {
      return _this._keyHandler(
        ev,
        _this._shouldHandleKeyUp,
        true /* dismissAllMenus */
      );
    };
    /**
    ...
    _this._shouldCloseSubMenu = function (ev) {
      var submenuCloseKey = getRTL(_this.props.theme)
        ? KeyCodes.right
        : KeyCodes.left;
      ...
      return (
        _this._adjustedFocusZoneProps.direction ===
  ...
  ContextualMenuBase.prototype.shouldComponentUpdate = function (
    newProps,
    newState
  ) {
    if (
    ...
    return (
      !shallowCompare(this.props, newProps) ||
      !shallowCompare(this.state, newState)
    );
  };
  // tslint:disable-next-line function-name
  ContextualMenuBase.prototype.UNSAFE_componentWillUpdate = function (
    newProps
  ) {
    ...
    if (
      ...
      this._gotMouseMove =
        this._shouldUpdateFocusOnMouseEvent && this._gotMouseMove;
    }
  };
  ...
  ContextualMenuBase.prototype.render = function () {
    ...
    var submenuProps =
      this.state.expandedMenuItemKey && this.props.hidden !== true
        ? this._getSubmenuProps()
        : null;
    isBeakVisible =
      isBeakVisible === undefined
    ...
    if (
      ...
      var targetWidth =
        targetBoundingRect.width - 2; /* Accounts for 1px border */
      if (useTargetWidth) {
        contextMenuStyle = {
          width: targetWidth,
        };
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          items && items.length
            ? React.createElement(
                FocusZone,
                __assign({}, this._adjustedFocusZoneProps, {
  ...
  ContextualMenuBase.prototype._onRenderSubMenu = function (
    subMenuProps,
    defaultRender
  ) {
    throw Error(
  ...
  ContextualMenuBase.prototype._renderSectionItem = function (
    sectionItem,
    // tslint:disable-next-line:deprecation
    menuClassNames,
    index,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            sectionProps.topDivider &&
              this._renderSeparator(index, menuClassNames, true, true),
            headerItem &&
            ...
            sectionProps.bottomDivider &&
              this._renderSeparator(index, menuClassNames, false, true)
          )
        )
      );
    }
  };
  ContextualMenuBase.prototype._renderListItem = function (
    content,
    key,
    classNames, // tslint:disable-line:deprecation
    title
  ) {
    return React.createElement(
      "li",
  ...
  ContextualMenuBase.prototype._renderNormalItem = function (
    item,
    classNames, // tslint:disable-line:deprecation
    index,
    focusableElementIndex,
  ...
  ContextualMenuBase.prototype._renderHeaderMenuItem = function (
    item,
    // tslint:disable-next-line:deprecation
    classNames,
    index,
  ...
  ContextualMenuBase.prototype._renderAnchorMenuItem = function (
    item,
    // tslint:disable-next-line:deprecation
    classNames,
    index,
  ...
  ContextualMenuBase.prototype._renderButtonItem = function (
    item,
    // tslint:disable-next-line:deprecation
    classNames,
    index,
  ...
  ContextualMenuBase.prototype._renderSplitButton = function (
    item,
    // tslint:disable-next-line:deprecation
    classNames,
    index,
  ...
  ContextualMenuBase.prototype._getSubmenuProps = function () {
    ...
    if (item) {
      submenuProps = {
        ...
        directionalHint: getRTL(this.props.theme)
