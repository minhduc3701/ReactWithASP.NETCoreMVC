...
import { anchorProperties, getNativeProps, memoizeFunction } from "../../index";
import { ContextualMenuItemWrapper } from "./ContextualMenuItemWrapper";
import { KeytipData } from "../../../../KeytipData";
import { isItemDisabled, hasSubmenu } from "../../../utilities/index";
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        function (keytipAttributes) {
          return React.createElement(
            "a",
            __assign({}, nativeProps, keytipAttributes, {
              ref: _this._anchor,
              href: item.href,
              target: item.target,
              rel: anchorRel,
              ...
              role: "menuitem",
              "aria-owns":
                item.key === expandedMenuItemKey ? subMenuId : undefined,
              "aria-haspopup": itemHasSubmenu || undefined,
              "aria-expanded": itemHasSubmenu
                ? item.key === expandedMenuItemKey
                : undefined,
              "aria-posinset": focusableElementIndex + 1,
              "data-rc-id": rcName ? `${rcName}.${item.key}` : undefined,
