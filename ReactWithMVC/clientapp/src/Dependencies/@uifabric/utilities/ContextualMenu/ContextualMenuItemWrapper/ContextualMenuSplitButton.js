...
var ContextualMenuSplitButton = /** @class */ (function (_super) {
    ...
    _this._onIconItemClick = function (ev) {
      ...
      if (onItemClickBase) {
        onItemClickBase(
          item,
          ev,
          _this._splitButton ? _this._splitButton : ev.currentTarget
        );
      }
    };
  ...
  ContextualMenuSplitButton.prototype.render = function () {
    ...
    return React.createElement(
      KeytipData,
      { keytipProps: keytipProps, disabled: isItemDisabled(item) },
      function (keytipAttributes) {
        return React.createElement(
          "div",
          {
            ...
            tabIndex: 0,
            "data-rc-id": rcName ? `${rcName}-${item.key}Btn` : undefined,
  ...
  ContextualMenuSplitButton.prototype._renderSplitPrimaryButton = function (
    item,
        ...
        __assign(
          {
            ...
            index: index,
            onCheckmarkClick:
              hasCheckmarks && onItemClick ? onItemClick : undefined,
            hasIcons: hasIcons,
          },
          itemComponentProps
        )
  ...
  ContextualMenuSplitButton.prototype._renderSplitIconButton = function (
    item,
  ...
  ContextualMenuSplitButton.prototype._handleTouchAndPointerEvent = function (
    ev
  ) {
    var _this = this;
