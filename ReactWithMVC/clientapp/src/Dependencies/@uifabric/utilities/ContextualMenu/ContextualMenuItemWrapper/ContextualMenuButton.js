...
import { buttonProperties, getNativeProps, memoizeFunction } from "../../index";
...
var ContextualMenuButton = /** @class */ (function (_super) {
  ...
  ContextualMenuButton.prototype.render = function () {
    ...
    var itemButtonProperties = {
      ...
      "aria-checked":
        (itemRole === "menuitemcheckbox" || itemRole === "menuitemradio") &&
        canCheck
          ? !!isChecked
          : undefined,
      "aria-selected":
        itemRole === "menuitem" && canCheck ? !!isChecked : undefined,
      role: itemRole,
