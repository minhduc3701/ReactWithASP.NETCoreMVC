...
} from "../Divider/VerticalDivider.classNames";
import {
  getMenuItemStyles
} from "./ContextualMenu.cnstyles";
import {
  mergeStyleSets,
  getGlobalClassNames,
  getScreenSelector,
 ...
 */
export var getItemClassNames = memoizeFunction(function (
  theme,
  disabled,
  expanded,
  checked,
    ...
    root: [
      ...
      !expanded && [{
        selectors: ((_a = {
          ...
          (_a["." + IsFocusVisibleClassName + " &:hover"] = {
            background: "inherit;",
          }),
          _a),
      }, ],
