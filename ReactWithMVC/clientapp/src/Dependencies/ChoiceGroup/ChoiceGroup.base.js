...
var ChoiceGroupBase = /** @class */ (function (_super) {
  ...
  function ChoiceGroupBase(props) {
    ...
    _this.state = {
      keyChecked: validDefaultSelectedKey
        ? defaultSelectedKey
  ...
  ChoiceGroupBase.prototype.componentDidUpdate = function (
    prevProps,
    prevState
  ) {
  ...
  ChoiceGroupBase.prototype.render = function () {
    ...
    var ariaLabelledBy =
      ...
      (label ? labelId : this.props["aria-labelledby"]);
