...
import { FirstWeekOfYear } from "../dateValues/dateValues";
import { Callout } from "../@uifabric/utilities/Callout";
import { DirectionalHint } from "../common/DirectionalHint";
import TextField from "../TextField/CustomTextField";
import { compareDates, compareDatePart } from "../dateMath/dateMath";
...
var DatePickerBase = /** @class */ (function (_super) {
  ...
  function DatePickerBase(props) {
    ...
    _this._onCalloutPositioned = function () {
      ...
      if (
        _this.props.calloutProps &&
        _this.props.calloutProps.setInitialFocus !== undefined
      ) {
  ...
  DatePickerBase.prototype.UNSAFE_componentWillReceiveProps = function (
    nextProps
  ) {
  ...
  DatePickerBase.prototype.componentDidUpdate = function (
    prevProps,
    prevState
  ) {
        ...
        React.createElement(
          ...
          __assign(
            ...
            textFieldProps,
            {
              ...
              iconProps: __assign(
                __assign({ iconName: "Calendar" }, iconProps),
                {
                  className: css(
                    classNames.icon,
      ...
      isDatePickerShown &&
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              CalendarType,
              __assign({ darkMode: darkMode, rcName: rcName }, calendarProps, {
  ...
  DatePickerBase.prototype._setErrorMessage = function (setState, nextProps) {
    var _a = nextProps || this.props,
      ...
      initialPickerDate = _a.initialPickerDate;
    var errorMessage =
      !initialPickerDate && isRequired && !value
        ? strings.isRequiredErrorMessage || " "
        : undefined;
  ...
  DatePickerBase.prototype._getDefaultState = function (props) {
    ...
    return {
      ...
      formattedDate:
        props.formatDate && props.value ? props.formatDate(props.value) : "",
      isDatePickerShown: false,
      errorMessage: this._setErrorMessage(false),
    };
  };
  DatePickerBase.prototype._isDateOutOfBounds = function (
    date,
    minDate,
    maxDate
  ) {
    return (
      (!!minDate && compareDatePart(minDate, date) > 0) ||
      (!!maxDate && compareDatePart(maxDate, date) < 0)
    );
  };
