...
(function (KeytipTransitionModifier) {
  KeytipTransitionModifier[
    (KeytipTransitionModifier["shift"] = KeyCodes.shift)
  ] = "shift";
  KeytipTransitionModifier[(KeytipTransitionModifier["ctrl"] = KeyCodes.ctrl)] =
    "ctrl";
  KeytipTransitionModifier[(KeytipTransitionModifier["alt"] = KeyCodes.alt)] =
    "alt";
  KeytipTransitionModifier[
    (KeytipTransitionModifier["meta"] = KeyCodes.leftWindow)
  ] = "meta";
