...
var ToggleBase = /** @class */ (function (_super) {
  ...
  ToggleBase.prototype.render = function () {
    ...
    var toggleNativeProps = getNativeProps(this.props, inputProperties, [
      "defaultChecked",
    ]);
    ...
    var renderPill = function (keytipAttributes) {
      ...
      return React.createElement(
        "button",
        __assign({}, toggleNativeProps, keytipAttributes, {
          ...
          "data-rc-id": rcName ? `tog.${rcName}` : undefined,
    ...
    return React.createElement(
      RootType,
      { className: classNames.root, hidden: toggleNativeProps.hidden },
      label &&
        React.createElement(
          Label,
          {
