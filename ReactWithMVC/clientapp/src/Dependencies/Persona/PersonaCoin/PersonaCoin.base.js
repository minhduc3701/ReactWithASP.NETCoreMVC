...
import { Image, ImageFit, ImageLoadState } from "../../@uifabric/Image";
import {
...
var PersonaCoinBase = /** @class */ (function (_super) {
  ...
  function PersonaCoinBase(props) {
    ...
    _this._onRenderInitials = function (props) {
      ...
      imageInitials =
        imageInitials ||
        getInitials(_this._getText(), isRTL, allowPhoneInitials);
      return imageInitials !== ""
        ...
        : React.createElement(Icon, { iconName: "Contact", rcName: rcName });
    };
  ...
  PersonaCoinBase.prototype.UNSAFE_componentWillReceiveProps = function (
    nextProps
  ) {
  ...
  PersonaCoinBase.prototype.render = function () {
    ...
    return React.createElement(
      "div",
      __assign({ role: "presentation" }, divProps, {
      ...
      size !== PersonaSize.size8 &&
        ...
        ? React.createElement(
            "div",
            __assign({ role: "presentation" }, divCoinProps, {
            ...
            React.createElement(
              PersonaPresence,
              __assign({ rcName: rcName }, personaPresenceProps)
            )
