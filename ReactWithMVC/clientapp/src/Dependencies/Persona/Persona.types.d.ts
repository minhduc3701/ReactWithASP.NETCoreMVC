...
import { ImageLoadState } from "../@uifabric/Image";
...
export interface IPersonaSharedProps
  extends React.HTMLAttributes<PersonaBase | PersonaCoinBase | HTMLDivElement> {
  /**
 ...
 * {@docCategory Persona}
 */
export declare type IPersonaPresenceStyleProps = Required<
  Pick<IPersonaSharedProps, "theme">
> &
  Pick<
    IPersonaSharedProps,
    "presence" | "isOutOfOffice" | "size" | "presenceColors"
  > &
