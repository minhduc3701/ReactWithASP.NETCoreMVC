...
import { ContextualMenu } from "../@uifabric/utilities/ContextualMenu/ContextualMenu";
...
var BaseButton = /** @class */ (function (_super) {
  ...
  function BaseButton(props) {
    ...
    _this._getMemoizedMenuButtonKeytipProps = memoizeFunction(function (
      keytipProps
    ) {
    ...
    _this._onRenderIcon = function (buttonProps, defaultRender) {
      ...
      if (
        iconProps &&
        (iconProps.iconName !== undefined || iconProps.imageProps)
      ) {
      ...
      if (_this._hasText()) {
        return React.createElement(
          "span",
          {
            ...
            id: _this._labelId,
            "data-rc-id": rcName ? `sp.${rcName}` : undefined,
          },
          text
        );
      }
    ...
    _this._onRenderMenu = function (menuProps) {
      var rcDropName = _this.props.rcName;
      var darkMode = _this.props.darkMode ? _this.props.darkMode : "";
    ...
    _this._onSplitContainerFocusCapture = function (ev) {
      ...
      if (
        !container ||
        (ev.target && portalContainsElement(ev.target, container))
      ) {
        return;
      }
  ...
  BaseButton.prototype.render = function () {
    ...
    var dataIsFocusable =
      this.props["data-is-focusable"] === false ||
    ...
    var checkedOrPressedValue = isCheckboxTypeRole
      ? !!checked
      : toggle === true
      ? !!checked
      : undefined;
    var buttonProps = assign(
      nativeProps,
      ((_a = {
        ...
        "data-rc-id": rcName ? `btn.${rcName}` : undefined,
      }),
  ...
  BaseButton.prototype.componentDidMount = function () {
    ...
    if (this._isSplitButton && this._splitButtonContainer.current) {
      ...
      if (
        "onpointerup" in this._splitButtonContainer.current &&
      ...
      return React.createElement(
        ...
        React.createElement(
          "span",
          {
            ...
            "data-rc-id": rcName ? `btn.sp.${rcName}` : undefined,
          },
  ...
  BaseButton.prototype._shouldRenderMenu = function () {
    ...
    if (!menuHidden) {
      ...
      persistMenu &&
      (this._renderedVisibleMenu || renderPersistedMenuHiddenOnMount)
    ) {
  ...
  BaseButton.prototype._hasText = function () {
    ...
    return (
      ...
      (this.props.text !== undefined || typeof this.props.children === "string")
    );
  };
  BaseButton.prototype._onRenderSplitButtonContent = function (
    tag,
    buttonProps
  ) {
    var _this = this;
    ...
    var SplitButton = function (keytipAttributes) {
      return React.createElement(
        ...
        __assign({}, containerProps, {
          "data-ktp-target": keytipAttributes
          ...
          onClick:
            !disabled && !primaryDisabled
              ? _this._onSplitButtonPrimaryClick
              : undefined,
  ...
  BaseButton.prototype._onRenderSplitButtonMenuButton = function (
    ...
    return React.createElement(
      BaseButton,
      __assign({}, splitButtonProps, {
        "data-ktp-execute-target": keytipAttributes
