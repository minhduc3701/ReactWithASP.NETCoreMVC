  ...
  function ProgressIndicatorBase() {
    ...
    _this._onRenderProgress = function (props) {
      var _a = _this.props,
        ...
        theme = _a.theme;
      var percentComplete =
        typeof _this.props.percentComplete === "number"
      ...
      var progressBarStyles = {
        width:
          percentComplete !== undefined ? percentComplete + "%" : undefined,
        transition:
          percentComplete !== undefined && percentComplete < ZERO_THRESHOLD
            ? "none"
            : undefined,
      };
      ...
      var ariaValueNow =
        percentComplete !== undefined ? Math.floor(percentComplete) : undefined;
      return React.createElement(
        ...
        React.createElement("div", {
          ...
          "data-rc-id": rcName ? `pgi.${rcName}` : undefined,
        })
      );
    };
    return _this;
