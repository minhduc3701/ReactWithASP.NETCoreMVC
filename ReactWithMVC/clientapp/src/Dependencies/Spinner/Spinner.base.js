...
var SpinnerBase = /** @class */ (function (_super) {
  ...
  SpinnerBase.prototype.render = function () {
    ...
    if (styleSize === undefined && type !== undefined) {
      // tslint:disable-next-line:deprecation
      styleSize =
        type === SpinnerType.large ? SpinnerSize.large : SpinnerSize.medium;
    }
    ...
    return React.createElement(
      ...
      __assign({}, nativeProps, {
        ...
        "data-rc-id": rcName ? `spi.${rcName}` : undefined,
      }),
      React.createElement("div", { className: classNames.circle }),
      label &&
        React.createElement("div", { className: classNames.label }, label),
      statusMessage &&
        React.createElement(
          "div",
