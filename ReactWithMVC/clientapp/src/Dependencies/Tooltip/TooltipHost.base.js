...
var TooltipHostBase = /** @class */ (function (_super) {
  ...
  function TooltipHostBase(props) {
    ...
    _this._onTooltipMouseEnter = function (ev) {
      ...
      if (
        ev.target &&
        portalContainsElement(ev.target, _this._getTargetElement())
      ) {
    ...
    return React.createElement(
      ...
      __assign(
        ...
        { onBlurCapture: this._hideTooltip },
        {
          ...
          "rc-title": content,
          "data-rc-id": rcName ? `tip.${rcName}` : undefined,
        }
      ),
      children,
      showTooltip &&
      ...
      isAriaPlaceholderRendered &&
        React.createElement(
          "div",
          { id: tooltipId, style: hiddenContentStyle },
          content
        )
    );
  };
