...
import { Layer } from "../@uifabric/utilities/Layer";
import { Overlay } from "../Overlay";
import { Popup } from "../@uifabric/utilities/Popup";
import {
...
import { FocusTrapZone } from "../@uifabric/utilities/FocusTrapZone";
...
var PanelBase = /** @class */ (function (_super) {
  ...
  function PanelBase(props) {
    ...
    _this._onRenderNavigation = function (props) {
      if (
        ...
        !_this.props.onRenderNavigation &&
        !_this.props.hasCloseButton
      ) {
        return null;
      }
      var _a = _this.props.onRenderNavigationContent,
        onRenderNavigationContent =
          _a === void 0 ? _this._onRenderNavigationContent : _a;
    ...
    _this._onRenderNavigationContent = function (props) {
      ...
      if (hasCloseButton) {
        var iconButtonStyles =
          (_a = _this._classNames.subComponentStyles) === null || _a === void 0
            ? void 0
            : _a.closeButton();
        return React.createElement(
          React.Fragment,
          ...
          React.createElement(IconButton, {
            ...
            rcName: rcName ? `close.${rcName}` : undefined,
          })
        );
      }
      return null;
            ...
            __assign(
              {
                ...
                role: "heading",
                "aria-level": 1,
                "data-rc-id": rcName ? `pnl.sp.${rcName}` : undefined,
                style: { fontSize: "28px", fontWeight: "500" },
              },
              headerTextProps,
              {
                className: css(
                  _this._classNames.headerText,
    ...
    _this._animateTo = function (newVisibilityState) {
      if (
        newVisibilityState === PanelVisibilityState.open &&
        _this.props.onOpen
      ) {
        _this.props.onOpen();
      }
    ...
    _this._onTransitionComplete = function () {
      ...
      if (
        _this.state.visibility === PanelVisibilityState.open &&
        _this.props.onOpened
      ) {
        _this.props.onOpened();
      }
      if (
        _this.state.visibility === PanelVisibilityState.closed &&
  ...
  PanelBase.prototype.componentDidUpdate = function (
    previousProps,
    previousState
  ) {
    ...
    if (this.state.visibility !== previousState.visibility) {
      ...
      if (this.state.visibility === PanelVisibilityState.animatingOpen) {
        ...
        this.state.visibility === PanelVisibilityState.animatingClosed
      ) {
  ...
  PanelBase.prototype.render = function () {
    ...
    var _j = this.state,
      ...
      id = _j.id;
    var isLeft =
      type === PanelType.smallFixedNear || type === PanelType.customNear
        ? true
        : false;
    var isRTL = getRTL(theme);
    var isOnRightSide = isRTL ? isLeft : !isLeft;
    var customWidthStyles =
      type === PanelType.custom || type === PanelType.customNear
        ? { width: customWidth }
        : {};
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          __assign({ "aria-hidden": !isOpen && isAnimating }, nativeProps, {
            ref: this._panel,
            ...
            __assign(
              {
                ...
                forceFocusInsideTrap:
                  !isBlocking || (isHiddenOnDismiss && !isOpen)
                    ? false
                    : forceFocusInsideTrap,
              ...
              focusTrapZoneProps,
              {
                ...
                "data-rc-id": rcName ? `pnl.${rcName}` : undefined,
              }
            ),
            React.createElement(
              "div",
              { className: _classNames.commands, "data-is-visible": true },
