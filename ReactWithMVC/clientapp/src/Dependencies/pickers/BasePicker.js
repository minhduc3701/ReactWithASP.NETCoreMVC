...
import { Callout, DirectionalHint } from "../@uifabric/utilities";
import {
  Selection,
  SelectionZone,
  SelectionMode,
...
var BasePicker = /** @class */ (function (_super) {
  ...
  function BasePicker(basePickerProps) {
    ...
    _this._styledSuggestions = getStyledSuggestions(
      _this.SuggestionOfProperType
    );
        ...
        if (_this.props.onDismiss) {
          _this.props.onDismiss(
            ...
            _this.suggestionStore.currentSuggestion
              ? _this.suggestionStore.currentSuggestion.item
              : undefined
          );
        }
    ...
    _this.refocusSuggestions = function (keyCode) {
      _this.resetFocus();
      if (
        _this.suggestionStore.suggestions &&
        _this.suggestionStore.suggestions.length > 0
      ) {
        if (keyCode === KeyCodes.up) {
          _this.suggestionStore.setSelectedSuggestion(
            _this.suggestionStore.suggestions.length - 1
          );
    ...
    _this.onBlur = function (ev) {
      if (_this.state.isFocused) {
        ...
        if (
          relatedTarget &&
          !elementContains(_this.root.current, relatedTarget)
        ) {
    ...
    _this.onClick = function (ev) {
      if (
        _this.props.inputProps !== undefined &&
      ...
      switch (keyCode) {
        ...
        case KeyCodes.del:
          if (!_this.props.disabled) {
            if (
              ...
              _this.suggestionStore.removeSuggestion(
        ...
        case KeyCodes.up:
          if (
            ...
            if (
              _this.suggestionElement.current &&
              _this.suggestionElement.current.tryHandleKeyDown(
                keyCode,
                _this.suggestionStore.currentIndex
              )
            ) {
      ...
      _this.setState(
        ...
        function () {
          if (_this.props.onGetMoreResults && _this.input.current) {
            var suggestions = _this.props.onGetMoreResults(
    ...
    _this.addItemByIndex = function (index) {
      _this.completeSelection(
        _this.suggestionStore.getSuggestionAtIndex(index).item
      );
    };
    ...
    _this._onResolveSuggestions = function (updatedValue) {
      var suggestions = _this.props.onResolveSuggestions(
        updatedValue,
        _this.state.items
      );
      if (suggestions !== null) {
    ...
    _this._completeGenericSuggestion = function () {
      if (
        ...
        var itemToConvert = _this.props.createGenericItem(
          _this.input.current.value,
          _this.props.onValidateInput(_this.input.current.value)
        );
  ...
  BasePicker.prototype.UNSAFE_componentWillUpdate = function (
    newProps,
    newState
  ) {
  ...
  BasePicker.prototype.componentDidMount = function () {
    ...
    this._onResolveSuggestions = this._async.debounce(
      this._onResolveSuggestions,
      this.props.resolveDelay
    );
  };
  // tslint:disable-next-line function-name
  BasePicker.prototype.UNSAFE_componentWillReceiveProps = function (newProps) {
    ...
    if (newItems) {
      ...
      if (newItems.length < this.state.items.length) {
        focusIndex_1 = this.state.items.indexOf(
    ...
    return React.createElement(
      ...
      React.createElement(
        FocusZone,
        {
          ...
          "aria-haspopup":
            suggestionsAvailable && this.suggestionStore.suggestions.length > 0
              ? "listbox"
              : "dialog",
        },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            this.canAddItems() &&
              React.createElement(
                Autofill,
                __assign({ spellCheck: false }, inputProps, {
                  ...
                  "aria-describedby":
                    items.length > 0 ? this._ariaMap.selectedItems : undefined,
                  "aria-controls":
                    suggestionsAvailable + " " + selectedSuggestionAlertId ||
                    undefined,
  ...
  BasePicker.prototype.onSuggestionSelect = function () {
    if (this.suggestionStore.currentSuggestion) {
      ...
      var itemValue = this._getTextFromItem(
  ...
  BasePicker.prototype.updateSuggestionsList = function (
    suggestions,
    updatedValue
  ) {
    var _this = this;
  ...
  BasePicker.prototype.resolveNewValue = function (updatedValue, suggestions) {
    ...
    this.setState(
      ...
      function () {
        return _this.setState({ suggestionsLoading: false });
      }
    );
  };
  ...
  BasePicker.prototype.getActiveDescendant = function () {
    ...
    return currentIndex > -1 && !this.state.suggestionsLoading
      ? "sug-" + currentIndex
      : undefined;
  };
   ...
   */
  BasePicker.prototype._updateAndResolveValue = function (
    updatedValue,
    newSuggestions
  ) {
    if (updatedValue !== undefined) {
...
var BasePickerListBelow = /** @class */ (function (_super) {
  ...
  BasePickerListBelow.prototype.render = function () {
    ...
    return React.createElement(
      "div",
      { ref: this.root, onBlur: this.onBlur },
      React.createElement(
        "div",
        { className: classNames.root, onKeyDown: this.onKeyDown },
        this.getSuggestionsAlert(classNames.screenReaderText),
        React.createElement(
          "div",
          {
            ...
            "aria-haspopup":
              ...
              this.suggestionStore.suggestions.length > 0
                ? "listbox"
                : "dialog",
            role: "combobox",
          },
          React.createElement(
            Autofill,
            __assign({}, inputProps, darkMode, type, {
              className: classNames.input,
              componentRef: this.input,
              onFocus: this.onInputFocus,
              onBlur: this.onInputBlur,
