...
export interface IPivotProps
  extends React.ClassAttributes<PivotBase>,
  ...
  rcName: string;
  onHandleMoveToLeft?: () => void;
  onHandleMoveToRight?: () => void;
  disableAction?: boolean;
}
/**
 * {@docCategory Pivot}
 */
export declare type IPivotStyleProps = Required<Pick<IPivotProps, "theme">> &
