  ...
  function SpinButton(props) {
    ...
    _this._calculatePrecision = function (props) {
      var _a = props.precision,
        precision =
          _a === void 0 ? Math.max(calculatePrecision(props.step), 0) : _a;
      return precision;
    };
    /**
    ...
    _this._defaultOnValidate = function (value) {
      ...
      var newValue = Math.min(
        _this.props.max,
        Math.max(_this.props.min, Number(value))
      );
    ...
    _this._updateValue = function (shouldSpin, stepDelay, stepFunction) {
      var newValue = stepFunction(_this.value || "");
      if (newValue !== undefined) {
        _this._lastValidValue = newValue;
        _this.setState({ value: newValue });
      }
  ...
  SpinButton.prototype.render = function () {
    ...
    return React.createElement(
      ...
      labelPosition !== Position.bottom &&
        ...
        React.createElement(
          "div",
          { className: `${classNames.labelWrapper} label-wrapper` },
          iconProps &&
            React.createElement(
              Icon,
              __assign({}, iconProps, {
      ...
      React.createElement(
        KeytipData,
        { keytipProps: keytipProps, disabled: disabled },
        function (keytipAttributes) {
          return React.createElement(
            "div",
            __assign({}, nativeProps, {
              className: `${classNames.spinButtonWrapper} input-wrapper`,
              ...
              __assign(
                {
                  ...
                  "data-rc-id": rcName ? `spb.${rcName}` : undefined,
                },
                inputProps
              )
            ),
                ...
                __assign(
                  {
                    ...
                    rcName: rcName ? `incre.${rcName}` : undefined,
                  },
                  iconButtonProps
                )
              ),
                ...
                __assign(
                  {
                    ...
                    checked:
                      keyboardSpinDirection === KeyboardSpinDirection.down,
                    disabled: disabled,
                    ...
                    "data-is-focusable": false,
                    rcName: rcName ? `decre.${rcName}` : undefined,
                  },
                  iconButtonProps
                )
              )
